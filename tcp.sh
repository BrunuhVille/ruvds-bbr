...
installbbr(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "6" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				wget -N -O kernel-headers-c6.rpm http://194.87.236.191:880/bbr/kernel-headers-c6.rpm
				wget -N -O kernel-c6.rpm http://194.87.236.191:880/bbr/kernel-c6.rpm
			...
			if [[ ${bit} = "x86_64" ]]; then
				wget -N -O kernel-headers-c7.rpm http://194.87.236.191:880/bbr/kernel-headers-c7.rpm
				wget -N -O kernel-c7.rpm http://194.87.236.191:880/bbr/kernel-c7.rpm
			...
			wget -N -O kernel-c8.rpm http://194.87.236.191:880/bbr/kernel-c8.rpm
			wget -N -O kernel-headers-c8.rpm http://194.87.236.191:880/bbr/kernel-headers-c8.rpm
		...
		if [[ "${release}" == "debian" ]]; then
			if [[ ${version} = "8" ]]; then
				if [[ ${bit} = "x86_64" ]]; then
					wget -N -O linux-image-d8.deb http://194.87.236.191:880/bbr/linux-image-d8.deb
					wget -N -O linux-headers-d8.deb http://194.87.236.191:880/bbr/linux-headers-d8.deb
			...
			if [[ ${version} = "16" ]]; then
				if [[ ${bit} = "x86_64" ]]; then
					wget -N -O linux-image-u16.deb http://194.87.236.191:880/bbr/linux-image-u16.deb
					wget -N -O linux-headers-u16.deb http://194.87.236.191:880/bbr/linux-headers-u16.deb
				...
				if [[ ${bit} = "x86_64" ]]; then
					wget -N -O linux-image-u18.deb http://194.87.236.191:880/bbr/linux-image-u18.deb
					wget -N -O linux-headers-u18.deb http://194.87.236.191:880/bbr/linux-headers-u18.deb
...
installbbrplus(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				wget -N -O kernel-headers-c7.rpm http://194.87.236.191:880/bbrplus/kernel-headers-c7.rpm
				wget -N -O kernel-c7.rpm http://194.87.236.191:880/bbrplus/kernel-c7.rpm
		...
		wget -N -O linux-headers.deb http://194.87.236.191:880/bbrplus/linux-headers.deb
		wget -N -O linux-image.deb http://194.87.236.191:880/bbrplus/linux-image.deb
...
installbbr2(){
	...
	if [[ "${release}" == "centos" ]]; then
		if [[ ${version} = "7" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				wget -N -O kernel-c7.rpm http://194.87.236.191:880/bbr2/kernel-c7.rpm
				wget -N -O kernel-headers-c7.rpm http://194.87.236.191:880/bbr2/kernel-headers-c7.rpm
				...
				wget -N -O kernel-c8.rpm http://194.87.236.191:880/bbr2/kernel-c8.rpm
				wget -N -O kernel-headers-c8.rpm http://194.87.236.191:880/bbr2/kernel-headers-c8.rpm
		...
		if [[ ${version} = "9" ]]; then
			if [[ ${bit} = "x86_64" ]]; then
				wget -N -O linux-image-d9.deb http://194.87.236.191:880/bbr2/linux-image-d9.deb
				wget -N -O linux-headers-d9.deb http://194.87.236.191:880/bbr2/linux-headers-d9.deb
			...
			if [[ ${bit} = "x86_64" ]]; then
				wget -N -O linux-headers-d10.deb http://194.87.236.191:880/bbr2/linux-headers-d10.deb
				wget -N -O linux-image-d10.deb http://194.87.236.191:880/bbr2/linux-image-d10.deb
